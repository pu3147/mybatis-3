...
public class ArrayUtil
{
	 ...
	 * 
	 * @param obj
	 *            The object to get a hash code for. May be an array or
	 *            <code>null</code>.
	 * @return A hash code of {@code obj} or 0 if {@code obj} is
	 *         <code>null</code>
	 */
	 ...
	 * <li>{@code thisObj} and {@code thatObj} are instances of the same type
	 * and {@link Object#equals(Object)} returns <code>true</code></li>
	 * <li>{@code thisObj} and {@code thatObj} are arrays with the same
	 * component type and equals() method of {@link Arrays} returns
	 * <code>true</code> (not deepEquals())</li>
	 * </ul>
	 * 
	 * @param thisObj
	 *            The left hand object to compare. May be an array or
	 *            <code>null</code>
	 * @param thatObj
	 *            The right hand object to compare. May be an array or
	 *            <code>null</code>
