...
/**
 * Tests for specify the behavior when detects an unknown column (or unknown
...
public class AutoMappingUnknownColumnBehaviorTest
{
	...
	{
		@Select(
		{ "SELECT ", "  ID,", "  USERNAME as USERNAMEEEE,", // unknown column
				"  PASSWORD,", "  EMAIL,", "  BIO", "FROM AUTHOR WHERE ID = #{id}" })
		Author selectAuthor(int id);
		
		@Select(
		{ "SELECT ", "  ID,", // unknown property type
