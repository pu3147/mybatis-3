...
public class ByteObjectArrayTypeHandlerTest extends BaseTypeHandlerTest
{
	...
	public void shouldGetResultFromResultSetByName() throws Exception
	{
		...
		assertThat(TYPE_HANDLER.getResult(rs, "column")).isEqualTo(new Byte[]
		{ 1, 2 });
	}
	...
	public void shouldGetResultFromResultSetByPosition() throws Exception
	{
		...
		when(rs.wasNull()).thenReturn(false);
		assertThat(TYPE_HANDLER.getResult(rs, 1)).isEqualTo(new Byte[]
		{ 1, 2 });
	}
	...
	public void shouldGetResultFromCallableStatement() throws Exception
	{
		...
		assertThat(TYPE_HANDLER.getResult(cs, 1)).isEqualTo(new Byte[]
		{ 1, 2 });
	}
