...
public class InlineCollectionWithDotTest
{
	...
	/*
	 * Load an element with an element with and element with a value. Expect
	 * that this is possible bij using an inline 'association' map.
	 */
	@Test
	...
	/*
	 * Load an element with an element with and element with a value. Expect
	 * that this is possible bij using an sub-'association' map.
	 */
	@Test
