...
public interface Mapper
{
	...
	{ @Result(id = true, column = "uid", property = "id"), @Result(column = "name", property = "name") })
	...
	@ConstructorArgs(
	{ @Arg(id = true, column = "uid", javaType = Integer.class), @Arg(column = "name", javaType = String.class) })
	@Select("select * from users where uid = #{id}")
