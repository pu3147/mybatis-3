...
public class Jdbc3KeyGeneratorTest
{
	...
	public void shouldErrorUndefineProperty()
	{
		...
		try
		{
			...
			then(caughtException()).isInstanceOf(PersistenceException.class).hasMessageContaining("### Error updating database.  Cause: org.apache.ibatis.executor.ExecutorException: Error getting generated key or setting result to parameter object. Cause: org.apache.ibatis.executor.ExecutorException: No setter found for the keyProperty 'country_id' in org.apache.ibatis.submitted.keygen.Country.");
		}
		finally
		{
			sqlSession.rollback();
